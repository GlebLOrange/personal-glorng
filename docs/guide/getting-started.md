...
make seed-db           # admin + mock data (needs SEED_PASSWORD in .env)
```
...
- [Handbook site](https://gleblorange.github.io/personal-glorng/) — published VitePress docs (enable GitHub Pages → GitHub Actions once)
