...
export const FIELD_INPUT_CLASS =
  ...
  "focus:outline-none focus:border-accent-blue transition-colors placeholder:text-surface-mid/50 h-[42px]";
...
export const FIELD_INPUT_CLASS_COMPACT =
  ...
  "focus:outline-none focus:border-accent-blue transition-colors placeholder:text-surface-mid/50 h-[34px]";
