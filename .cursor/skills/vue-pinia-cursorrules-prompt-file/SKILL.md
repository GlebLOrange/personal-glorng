---
name: vue-pinia-cursorrules-prompt-file
description: Vue 3 and TypeScript state management guidance for Pinia stores, Composition API usage, persistence, and testing.
---
...
- Use the existing API/composable layer for server state.
...
- Use stores inside setup, getters, actions, or router guards where the active Pinia instance is available.
- Do not read browser-only storage during module initialization.
